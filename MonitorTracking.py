# This file has compatibility  issues with newer version of mediapipe, the one that works is too old for current python version so I had to create a 
# separate environment with an older python version in anaconda, just to get it running and see how it works. Below is the command I use to run it:
# C:\Users\ahsan\miniconda3\envs\eyetracker\python.exe "D:\Research\Github Repos\EyeTracker\Webcam3DTracker\MonitorTracking.py"

# If you don't have anaconda you can try installing  python 3.11 but I think if we can edit and update the "face mesh" part, it will resolve these issues
import cv2
import numpy as np
import os
